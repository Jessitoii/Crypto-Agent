...
INPUT_FILE = "data/nexus_elite_v2_12.json"
OUTPUT_FILE = "data/nexus_elite_v2_12_ultra_pure_groq.json"
...
if __name__ == "__main__":
    if GROQ_API_KEY == "YOUR_GROQ_API_KEY":
        ...
        try:
            ...
            # --- İŞ BİTİNCE KAPATMA KODU ---
            print("💤 İşlem bitti. Bilgisayar 60 saniye içinde kapatılıyor...")
